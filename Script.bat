...
cscript.exe "\\jc1dfs2\applications\Desktop\WriteLog.vbs" %Program%
...
start /wait cscript.exe \\jc1dfs2\systems\Rename.vbs
GOTO RenameAgain
:RenameNO
...
copy \\jc1dfs2\systems\shutdown.bat c:\temp\shutdown.bat
echo.
C:\temp\shutdown.bat
GOTO ShutdownAgain
:ShutdownNoFlush
...
copy \\jc1dfs2\systems\restart.bat c:\temp\restart.bat
echo.
c:\temp\restart.bat
GOTO RestartAgain
:RestartNoFlush
